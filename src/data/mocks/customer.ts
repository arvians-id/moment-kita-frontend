...
export const mockCustomerInvitations: readonly CustomerInvitation[] = [
  ...
  },
  {
    ...
    templateName: "Provence Lavender",
    templateDescription:
...
export const mockEntitlement: EntitlementSummary = {
  ...
  quotaGranted: 4,
  quotaRemaining: 1,
  quotaNote: "3 of 4 celebration quotas committed: 1 from your Signature package plus 3 granted by our concierge team. Drafts never consume quota.",
  features: [
